...
*/
/*
<PerspectiveCamera name="Camera_Orientation" makeDefault={true} far={1000} near={0.1} fov={78.051} rotation={[-Math.PI / 2, 0, 0]} />
*/
...
export function Model(props) {
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
        <group name="Camera" position={[3.657, 35.831, 22.701]} rotation={[0.653, 0.011, -0.008]}>
        </group>
        <group name="AreaLightBed" position={[-7.663, 12.009, -16.475]} scale={10.844} />
        <group name="AreaLightBath" position={[6.797, 12.065, -16.627]} scale={10.844} />
        <group name="AreaLightLiving" position={[0.723, 12.17, -3.627]} scale={10.844} />
